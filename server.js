...
// const sequelize = new Sequelize("ntechabp_alwasit", "ntechabp_alwasitapi_user", "09123456789@nn", {
//   host: "91.204.209.39",
//   dialect: "mysql",
// });
...
const corsOptions = {
  origin: '*',
  methods: ['GET', 'POST', 'PUT', 'DELETE'], // Make sure PUT is included
...
const countRoutes = require('./Route/countroute');   //////  count 
